...
public class YouTubeController {
    ...
    public List<YouTubeResponseDto> getGameHighlights(@RequestParam String date) {
    ...
    public List<YouTubeResponseDto> getPlayerHighlights(@RequestParam String playerName) {
