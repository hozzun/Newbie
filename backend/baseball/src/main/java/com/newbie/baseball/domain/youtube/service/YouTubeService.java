...
public class YouTubeService {
    ...
    // Extracted method to process search results and create video details
    private List<String> extractVideoDetails(List<SearchResult> searchResults) {
        ...
        if (searchResults != null && !searchResults.isEmpty()) {
            for (SearchResult searchResult : searchResults) {
                ...
                videoDetails.add("Title: " + videoTitle + "\nURL: https://www.youtube.com/watch?v=" + videoId);
            }
        } else {
            videoDetails.add("검색 결과가 없습니다");
        }
