...
public class UsedBoardController {
    ...
    public ResponseEntity<UsedBoardResponseDto> createUsedBoard(
            @ModelAttribute @Parameter(description = "userId, title, content, tagList, price, region") UsedBoardRequestDto usedBoardDto) throws IOException {
        return ResponseEntity.status(HttpStatus.CREATED).body(usedBoardService.createUsedBoard(usedBoardDto));
    }
