...
const PhotoCardDetail = () => {
  ...
  const getPlayer = async () => {
    ...
    try {
      const response = await axiosInstance.get(`/api/v1/baseball/players/photos/${team}/${no}`, { params });
  ...
  const deletePlayer = async () => {
    ...
    try {
      const response = await axiosInstance.delete("/api/v1/cardstore/cards/delete", { params });
