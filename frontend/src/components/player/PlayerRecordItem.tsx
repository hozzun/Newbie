...
const PlayerRecordItem = (props: PlayerRecordItemProps) => {
  return (
    <div
      className={`mx-auto flex flex-col justify-center items-center p-2 bg-gray-100 ${props.isSelected ? "bg-gray-200" : "bg-gray-100"} rounded-lg aspect-[1/1] max-w-[96px] w-full hover:cursor-pointer hover:bg-gray-200`}
