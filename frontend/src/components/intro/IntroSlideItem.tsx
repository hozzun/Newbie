...
const IntroSlideItem = ({ imgSrc, text1, text2 }: SlideItemProps) => {
  return (
    <div className="flex flex-col items-center justify-center h-full space-y-12 text-center px-8 my-[10%]">
      <img
        src={imgSrc}
        alt={text1}
        className="w-full max-w-[90%] h-auto object-contain rounded-lg"
      />
